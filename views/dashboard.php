    ...
    <main class="dashboard">
        ...
        <section popover id="author" class="pop-card">
            <div class="pop-card-content">
                ...
                <a href="<?= BASE_URL ?>/views/autor/listarAutores.php">Listar Autores</a>
       ...
       <section popover id="user" class="pop-card">
            <div class="pop-card-content">
                ...
                <a href="<?= BASE_URL ?>/views/user/listar.php">Listar Utilizadores</a>
          ...
          <section popover id="borrow" class="pop-card">
            <div class="pop-card-content">
                ...
                <a href="<?= BASE_URL ?>/views/livro/listarEmprestados.php">Listar Emprestimos</a>
